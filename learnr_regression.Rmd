...
### What if I'm unsure what is the "

**Note** Sometimes, typically in 'natural' surveys, it may not be
obvious which is the response and which is the explanatory. For example,
...
**Note** You will often see the type of linear model described in this
tutorial as described as a **regression analysis** in many textbooks.

## Plotting the data
### The data

These are from a laboratory experiment to investigate the relationship
between caterpiller growth rates and the amount of tannins in their
diet. Before you continue, answer the following question:
